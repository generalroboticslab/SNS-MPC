...
CONFIG_DIR = "Logs"
LOG_DIR = os.path.join(CONFIG_DIR, "Training")
...
def dispatch(config):
    ...
    from Training.Go2_dog import train
    train.main(**config)
...
def main():
    ...
    train_parser.add_argument("--lr_dynamics", type=float)
    train_parser.add_argument("--lr_observer", type=float)
    train_parser.add_argument("--weight_decay_dynamics", type=float)
    train_parser.add_argument("--weight_decay_observer", type=float)
    train_parser.add_argument("--nn_model_type", type=str)
    train_parser.add_argument("--nn_policy_type", type=str)
    train_parser.add_argument("--nn_dynamics_kwargs", type=json.loads)
    train_parser.add_argument("--nn_observer_kwargs", type=json.loads)
    train_parser.add_argument("--nn_policy_kwargs", type=json.loads)
    train_parser.add_argument("--data_collection_policy_kwargs", type=json.loads)
    train_parser.add_argument("--data_collection_kwargs", type=json.loads)
    train_parser.add_argument("--n_training_steps", type=int)
    train_parser.add_argument("--buffer_size", type=int)
    train_parser.add_argument("--buffer_replace_rate", type=float)
    train_parser.add_argument("--n_workers", type=int)
    train_parser.add_argument("--trial_name", type=str)
    train_parser.add_argument("--n_envs", type=int)
    train_parser.add_argument("--n_env_workers", type=int)
    train_parser.add_argument("--save_video", type=str2bool)
    train_parser.add_argument("--buffer_path", type=str)
    train_parser.add_argument("--buffer_save", type=str2bool)

    train_parser.add_argument("--seed", type=int)
    train_parser.add_argument("--dtype", type=str)
    train_parser.add_argument("--n_rollouts", type=int)
    train_parser.add_argument("--accum_steps", type=int)
    train_parser.add_argument("--loss_fn", type=str)
