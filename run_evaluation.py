...
def dispatch(config):
    from Deploy_simulation.Go2_dog import eval
    eval.main(**config)
...
def main():
    ...
    train_parser.add_argument("--n_seeds", type=int)
    train_parser.add_argument("--with_state_estimation", type=str2bool)
    train_parser.add_argument("--ckpt_dirs", type=json.loads)
    train_parser.add_argument("--ckpt_names", type=json.loads)
    train_parser.add_argument("--steps", type=json.loads, default=None)
